...
//                alert(other_charges);
	...
	function display_lineitem_html(lineitem_objectdata,is_use_db_round_off_amount){
		...
		$.each(lineitem_objectdata, function (index, value) {
			...
			'<td class="text-right <?php echo isset($line_item_fields['discount']) ? $line_item_fields['discount'] : ''; ?>">' + discount_data + '</td>' +
			'<td class="text-right <?php echo isset($line_item_fields['basic_amount']) ? $line_item_fields['basic_amount'] : ''; ?>">' + parseF(value.discounted_price) + '</td>' +
			'<td class="text-right <?php echo isset($line_item_fields['cgst_per']) ? $line_item_fields['cgst_per'] : ''; ?>">' + value.cgst + '% - ' + value.cgst_amt + ' Rs. </td>' +
			'<td class="text-right <?php echo isset($line_item_fields['sgst_per']) ? $line_item_fields['sgst_per'] : ''; ?>">' + value.sgst + '% - ' + value.sgst_amt + ' Rs. </td>' +
			'<td class="text-right <?php echo isset($line_item_fields['igst_per']) ? $line_item_fields['igst_per'] : ''; ?>">' + value.igst + '% - ' + value.igst_amt + ' Rs. </td>' +
			'<td class="text-right <?php echo isset($line_item_fields['other_charges']) ? $line_item_fields['other_charges'] : ''; ?>">' + value.other_charges + '</td>' +
