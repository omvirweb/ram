                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="" id="">
                                        ...
                                        <b>Current Balance : <span class="against_account_curr_balance"></span></b>
                                        <div class="clearfix"></div><br/>
                                    </div>
                                </div>
                                <div class="col-md-6">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.ajax({
            url: "<?= base_url('app/get_account_balance/'.$against_account_id) ?>",
            type: "GET",
            dataType: 'json',
            success: function (res) {
                $('.against_account_curr_balance').html(res.balance);
            },
        });
        <?php }?>
        ...
        $(document).on('change', '#against_account_id', function(){
            var account_id = $('#against_account_id').val();
            if(account_id != null) {
                $.ajax({
                    url: "<?= base_url('app/get_account_balance/') ?>" + account_id,
                    type: "GET",
                ...
                $('.against_account_curr_balance').html('');
            }
        });
