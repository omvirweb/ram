    ...
    <body>
        <table border="1" style="width: 100%; font-size: 13px">
            ...
            <tr align="center" class="border1">
                <td align="center" colspan="15" class="border1" style="background-color: #EAEAEA;"><h2><?= isset($user_name) ? $user_name : '' ?></h2></td>
            </tr>
            <tr align="center" style="border: 1px 0px 1px 0px;">
                <td align="center" colspan="15"  class="">
            ...
            <?php } ?>
            <tr class="border1">
                <td colspan="5" class="text_bold no-border-right" style="text-align: left;">Debit Memo</td>
                <td colspan="5" class="text_bold text_center no-border-left no-border-right" style="text-align: center;">
                    <?php
                        $invoice_type = $this->crud->get_id_by_val('invoice_type','invoice_type','invoice_type_id',$purchase_invoice_data->invoice_type);
            ...
            <tr class="">
                ...
                <td colspan="3" class="text_bold text_left no-border-left no-border-bottom"> : <?=isset($purchase_invoice_no) ?$purchase_invoice_no : '' ?></td>
            </tr>
            <tr class="">
                <td colspan="1" rowspan="3" valign="top" class="text_bold text_left no-border-bottom no-border-right no-border-top">Address &nbsp;&nbsp;<b class="text_bold"> : </b></td>
                ...
                <td colspan="3" valign="top" class="text_bold text_left no-border-bottom no-border-left no-border-top"><b> : </b><?=isset($purchase_invoice_date) ? $purchase_invoice_date : '';?></td>
            </tr>
            <tr class="">
            ...
            <tr class="border1" style="background-color: #EAEAEA;">
                <td colspan="10" class="text_bold">GSTIN No. : <?=isset($user_gst_no) ? $user_gst_no : '' ?></td>
            ...
            <tr class="">
                <td colspan="3" class="no-border-right no-border-bottom text_bold">Bank Name</td>
            ...
            <tr class="">
                <td colspan="3" class="no-border-right no-border-top no-border-bottom text_bold">Branch</td>
