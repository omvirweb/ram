	...
	<section class="content-header">
		<h1>
	        ...
	        <?php if($this->applib->have_access_role(MASTER_USER_ID, "add")){ ?>
	            <a href="<?=base_url('master/user');?>" class="btn btn-primary pull-right">Add New</a>
	        <?php } ?>
		</h1>
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<form id="frm-action" action="" method="POST">
							<div class="btn-group">
								<button type="button" class="btn btn-success anchor-btn activate" data-href="<?=base_url('master/activate_status/')?>" data-name="activate" id="active">Active</button>
								<button type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown">
									<span class="caret"></span>
									<span class="sr-only">Toggle Dropdown</span>
								</button>
								<ul class="dropdown-menu" role="menu">
									<li><a href="javascript:void(0);" class="anchor-btn activate" data-href="<?=base_url('master/activate_status/')?>" data-name="activate">Active</a></li>
									<li class="divider"></li>
									<li><a href="javascript:void(0);" class="anchor-btn deactivate" data-href="<?=base_url('master/deactivate_status/')?>" data-name="deactivate">InActive</a></li>
									<li class="divider"></li>
									<li><a href="javascript:void(0);" class="anchor-btn delete" data-href="<?=base_url('master/multiple_delete/')?>" data-name="delete">Delete</a></li>
...
<script type="text/javascript">
	...
	$(document).ready(function (){
		var table = $('#example').DataTable({
			...
			"aaSorting": [[3, 'asc']],
			"ajax": {
				"url": "<?php echo base_url('master/user_datatable')?>",
				"type": "POST"
			},
