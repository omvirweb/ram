        ...
        <table border="1" style="width: 100%; font-size: 13px">
            ...
            <tr class="border1">
                ...
                <td valign="top" colspan="5" class="no-border-left text_bold">For, <?= isset($user_name) ? $user_name : '' ?><br/>
                    <br/>
                    <img style="height: 50px;" src="<?php echo base_url('assets/uploads/images/steamp-only.png');  ?>" class="saas-logo" alt="saas-logo">
                    <img style="height: 50px;" src="<?php echo base_url('assets/uploads/images/signature-only.png');  ?>" class="saas-logo" alt="saas-logo">
                    <img style="height: 50px;" src="<?php echo base_url('assets/uploads/images/signature-only.png');  ?>" class="saas-logo" alt="saas-logo">
                    <img style="height: 50px;" src="<?php echo base_url('assets/uploads/images/signature-only.png');  ?>" class="saas-logo" alt="saas-logo">
                    <br/>
