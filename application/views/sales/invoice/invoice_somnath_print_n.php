    ...
    <body>
        <table border="1" style="width: 100%; font-size: 13px">
            ...
            <tr>
                ...
                <td valign="top" colspan="7" align="left"><?php echo $lineitem->item_name;?><br><?php echo $lineitem->note;?>
                    <br />
                    Note : 69250/- (14*69250=969500) the price of the computer was quoted by RA on the GEM portal. <br />
                    67250/- (14*67250=941500) then the price of computer for offline negotiation will have to be paid.
                </td>
