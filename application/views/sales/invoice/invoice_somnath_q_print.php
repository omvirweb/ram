...
<html>
    <head>
        <title>Format 3 Sales Inv Quote Print</title>
        <meta charset="utf-8">
    ...
    <body>
        <table border="1" style="width: 100%; font-size: 13px">
            ...
            <?php } ?>
            <tr class="border1">
                <td colspan="6" class="text_bold no-border-right" style="text-align: left;"></td>
            ...
            <tr class="">
                ...
                <td colspan="3" class="text_bold text_left no-border-right no-border-bottom">Quote No.</td>
