                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="tr_type" id="tr_type" class="form-control select2">
                                            <option value="0">Payable/Receivable</option>
                                            <option value="1" <?=$tr_type == 1?"selected":""?>>Payable</option>
                                            <option value="2" <?=$tr_type == 2?"selected":""?>>Receivable</option>
                                            <option value="3" <?=$tr_type == 3?"selected":""?>>Bill Wise Payable/Receivable</option>
                                            <option value="4" <?=$tr_type == 4?"selected":""?>>Bill Wise Payable</option>
                                            <option value="5" <?=$tr_type == 5?"selected":""?>>Bill Wise Receivable</option>
                                        </select>
                                    </div>
                                </diV>
                                <div class="col-md-3">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
        ...
        table = $('.summary_table').DataTable({
            ...
            "order": [[0, 'asc']],
            "ajax": {
                "url": "<?php echo base_url('report/summary_billwise_datatable')?>",
                "type": "POST",
                "data": function(d){
...
function search_data() {
    var tr_type = $('#tr_type').val();
    if(tr_type == "0" || tr_type == '1' || tr_type == '2') {
    ...
    if(tr_type == '1' || tr_type == '4'){
        table.column( 4 ).visible( false );
    } else {
        table.column( 4 ).visible( true );
    }
    if(tr_type == '2' || tr_type == '5'){
