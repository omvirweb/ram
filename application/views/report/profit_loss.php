...
<script type="text/javascript">
    ...
    var title = 'Profit Loss (From Date : ' + $('#datepicker1').val() + ' To Date : ' + $('#datepicker2').val() +')';
	...
	table = $('#profit_loss_table').DataTable({
            ...
            buttons: [
                ...
                $.extend( true, {}, buttonCommon, { extend: 'csvHtml5',footer: true, title: function () { return (title)}, customize: function (csv) {
                        return 'Profit Loss ( From Date : ' + $('#datepicker1').val() + ' To Date : ' + $('#datepicker2').val() + ' )\n\n'+  csv;
                    } 
                }),
                $.extend( true, {}, buttonCommon, { extend: 'pdf',footer: true, orientation: 'portrait', pageSize: 'LEGAL', title: function () { return (title)}, action: newExportAction,
                    customize : function(doc){
                        ...
                        var rowCount = document.getElementById("profit_loss_table").rows.length;
            ...
            "bInfo" : false,
            "ajax": {
                "url": "<?php echo base_url('report/profit_loss_datatable')?>",
                "type": "POST",
                "data": function(d){
