...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		table = $('.sales-table').DataTable({
            ...
            buttons: [
                ...
                $.extend( true, {}, buttonCommon, { extend: 'pdf', orientation: 'landscape', pageSize: 'LEGAL', title: function () { return (title)}, action: newExportAction,
                    customize : function(doc){
						...
						doc.content[1].table.widths = ["2%", "10%", "3%", "10%", "5%", "10%", "10%", "10%", "5%", "5%", "5%", "8%"]; //costringe le colonne ad occupare un dato spazio per gestire il baco del 100% width che non si concretizza mai
			...
			"aaSorting": [[1, 'desc']],
			"ajax": {
				"url": "<?php echo base_url('report/sales_bill_datatable')?>",
				"type": "POST",
				"data": function(d){
			...
			"footerCallback": function (row, data, start, end, display) {
                ...
                $(api.column(5).footer()).html(total_amt5.toFixed(2));
                var total_amt6 = api
                        .column(6)
                        .data()
                        .reduce(function (a, b) {
                ...
                $(api.column(6).footer()).html(total_amt6.toFixed(2));
                var total_amt7 = api
                        .column(7)
                        .data()
                        .reduce(function (a, b) {
