            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    ...
                    <div class="box-footer">
                        ...
                        <div class="col-md-9">
                            <a href="<?=base_url('gstr_3b_excel/gstr_3b_excel_export');?>/<?php echo date('d-m-Y').' - '.date('d-m-Y'); ?>" class="btn btn-primary gstr_3b_excel_export" >GSTR-3B Excel Export</a>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(document).on('change','input[name="daterange_export"]',function(){
            $('.gstr_3b_excel_export').attr('href', '<?=base_url("gstr_3b_excel/gstr_3b_excel_export");?>/' + $("#daterange_export").val());
        });
    });
</script>
