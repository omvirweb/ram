(() => {
            ...
            152: (e, t, r) => {
                ...
                e.exports = function (e) {
                    var t, r = "",
                        a = e || {};
                    return function (e, a) {
                        r += '<div class="container-fluid" id="uploaderCont"><div class="row ddHandler"><div class="col-12" id="dragandrophandler"><svg class="bi bi-upload" width="1em" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M.5 8a.5.5 0 01.5.5V12a1 1 0 001 1h12a1 1 0 001-1V8.5a.5.5 0 011 0V12a2 2 0 01-2 2H2a2 2 0 01-2-2V8.5A.5.5 0 01.5 8zM5 4.854a.5.5 0 00.707 0L8 2.56l2.293 2.293A.5.5 0 1011 4.146L8.354 1.5a.5.5 0 00-.708 0L5 4.146a.5.5 0 000 .708z" clip-rule="evenodd"></path><path fill-rule="evenodd" d="M8 2a.5.5 0 01.5.5v8a.5.5 0 01-1 0v-8A.5.5 0 018 2z" clip-rule="evenodd"></path></svg><span>Drag files here or<label>browse for files<input value="browse" type="file" style="display: block;" name="docs[]" multiple></label></span></div></div>\x3c!--.row.fileQueue--\x3e<div class="row queueSrc"><div class="col name"><b></b></div>', a && (r += '<div class="col desc"><input name="docs_desc[]" class="form-control form-control-sm" type="text" placeholder="Description of file" maxlength="100"></div>'), e && (r += '<div class="col options"><select name="docs_type[]" class="custom-select custom-select-sm"><option selected>Select this file type</option>', function () {
                            var a = e;
                            if ("number" == typeof a.length)
                                for (var n = 0, i = a.length; n < i; n++) {
                                    ...
                                    for (var n in i = 0, a) i++, s = a[n], r = r + "<option" + o.attr("value", n, !0, !0) + ">" + o.escape(null == (t = s) ? "" : t) + "</option>"
    ...
    r.n = e => {
        ...
        var e = r(379),
            ...
            f = r(27),
            v = {};
        v.styleTagTransform = p(), v.setAttributes = l(), v.insert = i().bind(null, "head"), v.domAPI = a(), v.insertStyleElement = c(), t()(f.Z, v), f.Z && f.Z.locals && f.Z.locals,
            function () {
                const e = r(152),
                    t = r(425);
                let o = [],
                ...
                function n(e) {
                    ...
                    for (let r = 0; r < e.length; r++) {
                        ...
                        $("<div class='row fileQueue'></div>").html(t).find(".col.name b").text(e[r].name).end().find(".remove input").attr("data-name", e[r].name).end().insertAfter(".row.ddHandler").animate({
                            opacity: 1
                        }, 850), o.push(e[r])
                    }
                ...
                $.fn.initUploader = function (r) {
                    ...
                    a = $.extend({}, i, r);
                    const s = {
                            showDesc: a.showDescription,
                            options: a.selectOpts
                        },
                        l = e(s),
                        d = t();
                    this.html(l), $("body").append(d), a.destinationParams && (a.destination = `${a.destination}?${$.param(a.destinationParams)}`), this.on("click change", "input[value]", (e => {
                        "Remove" == e.currentTarget.attributes.value.nodeValue ? function (e) {
                            ...
                            t.animate({
                                opacity: 0
                            }, 400, (() => t.remove())), $(".row.submit").css("display", (() => o.length ? "flex" : "none"))
                        }(e.currentTarget) : "Upload" == e.currentTarget.attributes.value.nodeValue ? function () {
                            let e = new FormData,
                                t = 0;
                            const r = $(".row.ulProgress .progress-bar"),
                                n = $(".row.fileQueue");
                            a.selectOpts && (File.prototype.fileType = "", o.map((e => (e.fileType = n.filter(`:has(input[data-name='${e.name}'])`).find(".col.desc input").val(), e)))), a.showDescription && (File.prototype.description = "", o.map((e => (e.description = n.filter(`:has(input[data-name='${e.name}'])`).find(".col.options select").val(), e)))), o.forEach((t => e.append("file", t))), n.animate({
                                opacity: 0
                            }, 400, (() => {
